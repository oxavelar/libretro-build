...
export DEBUG=0
export CFLAGS="-O3 -fomit-frame-pointer -flto=${BUILD_THREADS} -fuse-ld=gold -fuse-linker-plugin -pipe"
export CFLAGS="${CFLAGS} -march=x86-64-v2 -mtune=generic"
export CXXFLAGS="${CFLAGS}"
export ASFLAGS="${CFLAGS}"
export LDFLAGS="${LDFLAGS} -Wl,-O2 -Wl,--hash-style=gnu -Wl,--as-needed -Wl,-flto"
